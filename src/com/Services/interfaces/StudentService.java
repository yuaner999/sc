...
public interface StudentService {
     ...
     * @return
     */
    List<Student_Decoding> loadStudents(Map<String ,Object> map,int pagenum,int rows);
    List<Student_Decoding> loadStudentsNew(Map<String ,Object> map,int pagenum,int rows);
    List<Student_Decoding> loadStudentsByClass(Map<String ,Object> map,int pagenum,int rows);
