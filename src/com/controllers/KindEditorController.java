...
/**
 * Created by liulei on 2016/2/19.
 */
@Controller
...
//        System.out.println("editor_dir="+dir);
    ...
    public void FileManager(HttpServletRequest request, HttpServletResponse response) throws Exception{
        ...
        String rootPath = application.getRealPath("/") + "assets/kindeditor-4.1.10/attached/";
        // 根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/upload/
        String rootUrl = request.getContextPath() + "/assets/kindeditor-4.1.10/attached/";
        // 图片扩展名
