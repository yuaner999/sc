...
<head>
    ...
    <script>
        ...
        //1、第一处修改，修改增删改的请求地址
        var addUrl = "/jsons/addCollege.form";
        var editUrl = "/jsons/editCollege.form";
        var deleteUrl = "/jsons/deleteCollege.form";
        var editorName = "null";//KindEditor的Textarea的ID，如果没用到，赋值为null
        var imageUpload = "";//图片上传的标识，如果没有图片上传，赋值为空，如果有，赋值为数据库存放图片名称的字段名称，不带_
        var deleteId = "collegeId";//用于删除功能的ID参数，赋值为当前数据库表的ID
    </script>
    <%--判断是否是登录状态--%>
...
<body>
    ...
    <table id="dg" class="easyui-datagrid" style="width:100%;min-height:556px;max-height: 100%;"
           data-options="pagination:true,
               ...
               url:'/jsons/loadCollege.form'">
        <thead>
            <tr>
                <%--3、第三处修改，修改此处的列名称，与数据库一致，显示有必要的--%>
                <th field="collegeId" hidden >ID</th>
                <th field="collegeName" width="100px">学院名称</th>
                <th field="collegeRemark" width="100px" hidden>备注</th>
    ...
    <div id="tb" style="height:auto">
        ...
        <input class="easyui-searchbox" data-options="prompt:'请输入学院名称',searcher:doSearch" style="width:200px"/>
    </div>
    <%--对话框--%>
    <div id="dlg" class="easyui-dialog hide" title=""
        ...
        <form id="Form">
            <div style="margin-bottom:10px;margin-top: 10px;display: none;">
                ...
                <input class="easyui-textbox" name="collegeId" id="collegeId">
            </div>
            <div style="margin-bottom:10px;margin-top: 10px;">
                <span class="word">学院名称:</span>
                <input class="easyui-textbox" data-options="required:true,validType:'length[1,50]'"
                       name="collegeName" id="collegeName" style="width:400px;height:32px">
            </div>
            <div style="margin-bottom:10px;margin-top: 10px;">
                <div class="word">备注:</div>
                <input class="easyui-textbox" data-options="multiline:true,validType:'length[0,100]'"
                       name="collegeRemark" id="collegeRemark" style="height:100px;width:100%;">
            </div>
        </form>
    </div>
    <%--对话框保存、取消按钮--%>
