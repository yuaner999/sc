...
<body>
    ...
    <table id="dg" class="easyui-datagrid" style="width:100%;min-height:556px;max-height: 100%;"
           data-options="pagination:true,
               ...
               url:'/jsons/loadActivities1.form'">
        <thead>
            <tr>
    ...
    <div id="dlg" class="easyui-dialog hide font1" title=""
        ...
        <form id="Form">
            ...
            <div style="margin-bottom:10px;margin-top: 10px;" >
                ...
                <div style="margin-bottom:10px;margin-top: 10px;">
                    <span class="word">是否可以线上报名:</span>
                    <input type="radio" name="online" value="0">可以
                    <input type="radio" name="online" value="1">不可以
                </div>
             </div>
            <div style="margin-bottom:10px;margin-top: 10px;">
            ...
            <div style="margin-bottom:10px;margin-top: 10px;">
                <span class="word">负责人:</span>
                <input class="easyui-textbox" data-options="validType:'length[1,50]'"
                       name="principal" id="principal" style="width:200px;height:32px">
            </div>
            <div style="margin-bottom:10px;margin-top: 10px;">
                <span class="word">负责人电话:</span>
                <input class="easyui-textbox" data-options="validType:'length[1,50]'"
                       name="principalphone" id="principalphone" style="width:200px;height:32px">
            </div>
<form/>
