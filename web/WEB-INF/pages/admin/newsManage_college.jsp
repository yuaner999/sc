...
<table id="dg" class="easyui-datagrid" style="width:100%;min-height:556px;max-height: 100%;"
       data-options="pagination:true,
              ...
              url:'/jsons/loadNews_college.form'">
    <thead>
    <tr>
...
<div id="dlg" class="easyui-dialog hide" title=""
    ...
    <form id="Form">
        ...
        <div id="userphoto_box" style="height: 20px; width: 230px; float: right;">
            <img id="user_photo" src="<%=request.getContextPath()%>/asset/image/default.jpg" style="width: 200px;height: 130px;margin-right: 5px;">
        </div>
    ...
    <div style="margin-bottom:10px;margin-top: 10px;">
        ...
        <textarea id="newsContent" name="newsContent" style="width:100%;height:500px;"></textarea>
    </div>
</div>
<%--对话框保存、取消按钮--%>
<div id="dlg-buttons">
