...
<head>
    ...
    <style type="text/css">
        ...
        #student_dlg{
            ...
            top:20%;
            left:50%;
            border: 1px solid rgb(25, 127, 254);
            background: #fff;
            z-index: 10000;
            display: none;
        }
        ...
        #student_dlg>p b{
            ...
            right: 20px;
            cursor: pointer;
            background-image: url(../../asset_admin_new/img/icon_new_cancel.png);
    ...
    <script type="text/javascript">
        ...
        var loadUrl = "/jsons/Activitiescollege.form";//注：此处为新增
        var sqlStr = "";//注：模糊查询
        var jsonPara;
...
//                console.log(str.substring(0,str.length-1))
        ...
        function  laodStudentinfor(page){
            ...
            console.log(rowdata.activityParticipation);
...
//                                    '<td class="applyStudentId ">'+row.applyStudentId+'</td>'+
                                    ...
                                    '<td class="activityAwardMean ">'+row.activityAward+'</td>'+
        ...
        <div id="edit"  style="display: none">
           <div id="userphoto_box" style="height: 60px; width: 400px; float: right;margin-top:15px;">
            ...
            <ul>
                ...
                <li>
                    <span>活动学分&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    <input type="text" id="activityCredit" name="activityCredit" class="combobox"  value="0.25"/>
                </li>
                <li>
                    <span>参与形式&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                ...
                <li>
                    ...
                    <%--<span class="input_memo_text">*报名截止时间不能晚于活动开始时间</span>--%>
                </li>
                <li>
                    <span>能力标签&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div id="student_dlg"  title="学生活动申请">
    <p>
        <span id="title">颁奖</span>
        <b onclick="apply_close()"></b>
    </p>
    <div  style="margin-bottom: 10px;margin-top: 10px;">
        <ul>
            <li style="position: relative;display: block;margin-bottom: 10px;padding-right: 14px;">
                ...
                <%--<img style="float: right;" src="../../../asset_font_new/img/windowclose_03.png" >--%>
            </li>
    ...
    <div id="a" class="new_buttons">
        <input type="button" value="确认"  style="margin-left: 72px;margin-top: 50px;width: 50px;" onclick="applyStudent()" />
        <input type="button" value="关闭"  style="margin-left: 48px;margin-top: 50px;width: 50px;" onclick="apply_close()" />
    </div>
    <div id="b" class="new_buttons">
        <input type="button" value="确认"  style="outline: none;margin-left: 72px;text-align:center;margin-top: 40px;width: 70px;" onclick="award()" />
        <input type="button" value="关闭"  style="outline: none;margin-left: 48px;text-align:center;margin-top: 40px;width: 70px;" onclick="apply_close()" />
    </div>
</div>
</body>
</html>