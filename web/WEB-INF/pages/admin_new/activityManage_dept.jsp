...
<head>
    ...
    <script type="text/javascript">
        ...
        var loadUrl = "/jsons/Activitiesdept.form";//注：此处为新增
        var sqlStr = "";//注：模糊查询
        var jsonPara;
...
//                                    '<td class="applyStudentId ">'+row.applyStudentId+'</td>'+
                                    ...
                                    '<td class="applyDates ">'+row.applyDates+'</td>'+
...
//                console.log(rowdata1);
        ...
        function uploadActivityFile(){
            ...
            load();
            $.ajaxFileUpload({
                url: "/dataupload/studentinfo.form?activityid="+rowdata.activityId, //用于文件上传的服务器端请求地址
        ...
        <div class="searchContent">
            <div>
                ...
                <ul>
                    ...
                    <li>
                        <span>活动学分:</span>
                        <input type="text" id="_activityCredit" value="" name="activityCredit"/>
                    </li>
                </ul>
            </div>
            <p></p>
           ...
           <div id="userphoto_box" style="height: 60px; width: 400px; float: right;margin-top:15px;">
            ...
            <ul>
                ...
                <li>
                    ...
                    <input type="text" id="activityEdate" name="activityEdate"  class="combobox" onclick="laydate()" />
        ...
        <div id="see" style="display: none">
            ...
            <div class="function">
                <ul>
                    ...
                    <li class="function_import" onclick="getModels()"><span>补充导入</span></li>
                    <li class="function_import" onclick="getModels()"><span>覆盖导入</span></li>
