...
//                    console.log(data);
                    ...
                    if (data != null && data.rows != null && data.rows.length > 0) {
                        for (var i = 0; i < data.rows.length; i++) {
                            var row = data.rows[i];
                            for(var key in row){
                                if(row[key]==null||row[key]=="null"||row[key]=="NULL"||typeof(row[key])=='undefined'||row[key]=='undefined'){
                                    row[key]="";
                                }
                            }
                            var title;
...
//                                    '<td class=" " title="'+row.activityTitle+'">'+title+'</td>'+
