...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            //重新设置菜单栏的最大高度，防止浏览器出现滚动条
            $('.menuBody').css('max-height', '790px');
            //重新设置右面内容区域的最大高度，防止浏览器出现滚动条
            $('.stuMsgManage').css('max-height', '780px');
        });
    </script>
    ...
    <script>
        ...
        var loadUrl = "/jsons/loadNews_college.form";//注：此处为新增
        var sqlStr = "";//注：模糊查询
        var jsonPara;//参数
        $(function(){
            //过滤下拉
...
//                                    '<td class="newsContent"><div>'+row.newsContent+'</div></td>'+
                                    '<td class="newsType ">'+row.newsType+'</td>'+
                                    '<td class="newsClass" >'+row.newsClass+'</td>'+
...
<%--        <div id="userphoto_box" style="height: 20px; width: 230px; float: right;">
        ...
        <ul>
            ...
            <li>
                <span>新闻类型&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <input id="newsType" name="newsType" class="select" value="学院新闻" readonly="true"/>
