...
//                                    '<td class="applyAuditStatus ">'+row.applyAuditStatus+'</td>'+
...
<div class="stuMsgManage">
    ...
    <div class="function">
        <ul>
            ...
            <%--<li class="function_edit" onclick="Edit1()"><span>审核</span></li>--%>
...
<div id="batch_dlg"  title="批量导入"  style="display:none;width:400px;height:380px;padding:10px;position:absolute;
    border:3px #c1dadb solid; left:35%;top:25%;background-color:#fff">
...
top: 13%;background: #fff;display: none;">
