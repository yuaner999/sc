                    ...
                    if (data != null && data.rows != null && data.rows.length > 0) {
                        for (var i = 0; i < data.rows.length; i++) {
                            ...
                            var tr = '<tr id="tr'+(i+1)+'" onclick=" SearchDetail(this)">'+
                                    ...
                                    '<td class="X" >' +
                                    '<li class="function_new function_auditPass" style="width: 65px;float:left;cursor: pointer" onclick="stopBubble(this),auditsAction(this)"><span>通过</span></li>' +
                                    '<li class="function_edit function_auditNotPass" style="width: 65px;float: right;cursor: pointer" onclick="stopBubble(this),auditsAction_no(this)"><span>不通过</span></li>' +
                                    '</td>'+
...
//            console.log($(val).parents("td").parents("tr").data());
            var type='已通过';
            //增加能力复选框验证
...
//            });
            ...
            if(collegeAuditStatuses.indexOf("未通过")>=0||collegeAuditStatuses.indexOf("修改")>=0){
                layer.msg("操作失败,该条数据学院审核结果为'未通过'");
                return;
            }
...
<div class="stuMsgManage">
    ...
    <div class="function">
        <ul>
            <li class="function_remove" onclick="delete_zy()"><a href=""></a><span>删除</span></li>
...
<form id="Form" class="demoform" action=""><!--存在为了提交-->
    <div id="dlg" class="new">
        ...
        <ul><li><input style="display:none" name="id"/></li>
            <li>
                <span>学生姓名&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</span>
