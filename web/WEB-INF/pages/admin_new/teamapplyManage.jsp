    ...
    <script>
        ...
        $(function(){
            ...
            $.ajax({
                ...
                data:{stuCollageName:''},
                success: function (data) {
                    var stuco = $("#collegeName");
                    stuco.empty();
                    stuco.append("<option value=''>请选择</option>");
                    stuco.append("<option value=''>全部</option>");
                    if(data.rows !=null && data.rows.length > 0){
                        for(var i=0;i<data.rows.length;i++) {
                            var options = $("<option>").text(data.rows[i].stuCollageName).val(data.rows[i].stuCollageName);
                            stuco.append(options);
                        }
                    }else{
                        var options = $("<option>").text("无");
                        stuco.append(options);
                    }
                }
            });
            ...
            $("#gradeName").change(function(){
                ...
                $.ajax({
                    url: '<%=request.getContextPath()%>/jsons/loadclassnames1.form',
                    dataType: "json",
                    data:{stuGradeName:$(this).val(),collegename:$("#collageName").val(),stuMajorName:$("#majorName").val()},
                    success: function (data) {
        ...
        function Saves(){
            ...
            if(notNull) {//表单验证
                ...
                if($("input[type=radio]:checked").val()=='true') {
                    postURL = "/jsons/addClassTeaminfor.form";
                    jsonObject["teamName"]=$("#className").val();
                }
                if(clickStatus=='edit'){
...
<form id="Form" class="demoform" action=""><!--存在为了提交-->
    <div id="dlg" class="new">
        ...
        <ul>
            <li id="_isteam">
                <span>是否以班级为团体报名:</span>
                <span style="display: inline-block;color: #1990fe;font-weight: bold;margin-left: 20px">是</span>
                <input type="radio" id="" name="status"  value="true"    style="width: 15px !important;"/>
                <span style="display: inline-block;color: #1990fe;font-weight: bold;margin-left: 20px">否</span>
                <input type="radio" id="" name="status"  value="false"  checked="checked" style="width: 15px !important;" />
            </li>
            <li id="stuTeam">
                <span>团体名字&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <input type="text" id="teamName" name="teamName"    />
            </li>
            <li id="stuCollege" style="display: none">
                <span>选择学院&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <select type="text" id="collegeName" name="collegeName" >
                </select>
            </li>
            <li id="stuMajor" style="display: none">
                <span>选择专业&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <select type="text" id="majorName" name="majorName" >
                </select>
            </li>
            <li id="stuGrade" style="display: none">
                <span>选择年级&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <select type="text" id="gradeName" name="gradeName" >
                </select>
            </li>
            <li id="stuClass" style="display: none">
                <span>选择班级&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <select type="text" id="className" name="className" >
                </select>
            </li>
            <li>
                <span>报名活动&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</span>
