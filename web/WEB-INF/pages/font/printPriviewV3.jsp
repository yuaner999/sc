        ...
        function bindActivityData(rows){
            ...
            for(var i=0;i<rows.length;i++){
                ...
                var str='<tr id='+activityClass+i+'>'+
                        ...
                        '<td>'+activityLevle+'</td>'+
                        '<td class="activityCredit">'+(row.activityCredit?row.activityCredit:"") + '</td>'+
            ...
            success:function(data){
                if(data.rows.length>0){
                    for(var i=0;i<data.rows.length;i++){
                        ...
                        if(item.dict_mean=='社会工作与技能培训类'){$('.score_get5').html('非必修类')}
                        if(item.dict_mean=='综合奖励及其他类'){$('.score_get6').html('非必修类');}
                    }
                }
            },
...
<div class="secondClassMsgContent">
    <div class="box1">
        ...
        <span id="autoID">编号:&nbsp;'<%=session.getAttribute("printId")%>'</span>
    ...
    <ul class="grade_list">
        ...
        <li class="grade_list_item">
            ...
            <%--<div class="box">--%>
                <%--&lt;%&ndash;<span class="score_get6"></span>&nbsp;&nbsp;/&ndash;%&gt;--%>
